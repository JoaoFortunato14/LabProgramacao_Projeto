...
@section('content')
<div class="container">
<form action="{{url('/EditVest/'.$vestuario->id)}}" method= "post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="exampleInputCourse">Category:</label>
        <select id="course" name="category" value="{{$vestuario->category}}">
    ...
    <div class="form-group">
      ...
      <input type="text" placeholder="Enter the name" name="name" value="{{$vestuario->nome}}" class="form-control" id="exampleInputName" aria-describedby="nameHelp">
    </div>
    <div class="form-group">
      <label for="exampleInputPrice">Preço:</label>
      <input type="text" placeholder="Enter the price" name="price" value="{{$vestuario->preco}}" class="form-control" id="exampleInputPrice" aria-describedby="priceHelp">
    </div>
    <div class="form-group">
      <label for="exampleInputPrice">Tamanho:</label>
      <input type="text" placeholder="Enter the size" name="tamanho" value="{{$vestuario->tamanho}}" class="form-control" id="exampleInputSize" aria-describedby="priceHelp">
    </div>     
    <div class="form-group">
      <label for="exampleInputInfo">Info:</label>
      <input type="text" placeholder="Enter info about the product" name="info" value="{{$vestuario->info}}" class="form-control" id="exampleInputInfo" aria-describedby="infoHelp">
    </div>  
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="file" name="file" value="{{$vestuario->imagem}}" class="form-control" id="exampleInputFile">
  </div>
